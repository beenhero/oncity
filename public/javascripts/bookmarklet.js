...
frames.length > document.getElementsByTagName('iframe').length) {
		window.location.href = 'http://friendfeed.com/?link=' + escape(window.location.href); // goto submit page
	} else {
		bookmarklet();
	}
